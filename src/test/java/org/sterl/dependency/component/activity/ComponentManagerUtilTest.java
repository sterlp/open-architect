...
import org.sterl.dependency.component.activity.ComponentManagerUtil;
...
public class ComponentManagerUtilTest {
    ...
    public void testDetermineBestQualified() {
        ...
        assertEquals("org.sterl.foo", ComponentManagerUtil.determineBestQualified(Arrays.asList("org.sterl", "org.sterl.foo")));
        
        assertEquals("org.sterl.bar", ComponentManagerUtil.determineBestQualified(Arrays.asList("org.sterl.bar", "org.sterl.foo")));
        assertEquals("org.sterl.bar.car", ComponentManagerUtil.determineBestQualified(Arrays.asList("org.sterl.bar.car", "org.sterl.foo")));
    }
}
